...
To-do/Próximos pasos sugeridos
- Añadir gestión de foco (focus trap) al abrir el menú para accesibilidad.
- Revisar y limpiar duplicados si prefieres no duplicar CTA entre header y nav.

Contacto rápido
- Si quieres que lo traduzca al inglés o extienda el README con instrucciones de deploy, tests o checklists de accesibilidad, dímelo y lo agrego.